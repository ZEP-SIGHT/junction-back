package com.junction.tonight.spark.common;
...
import com.junction.tonight.spark.common.utils.ObjectUtils;
import com.junction.tonight.spark.common.utils.StringUtils;
...
public class ObjectConverter {
    ...
    static public String toPrettyJson(String json) throws JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
        mapper.disable(SerializationFeature.FAIL_ON_EMPTY_BEANS);
        Map<String, Object> bean = toMap(json);
        String jsonString = null;
        if (!ObjectUtils.isEmpty(bean)) {
            jsonString = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(bean);
        }
    ...
    static public <T> T toObject(Object o, Class<T> clazz) throws JsonProcessingException {
        return toObject(toJson(o), clazz);
    }
